...
export default {
    ...
    argTypes: {
        source: {
          description: 'Source is a background which Background component renders, should be named by one word',
          table: {
            type: {
              summary: 'Detailed description',
              detail: 'To use background component, first you have to set its source by importing it: "Import video from "./src""',
            },
          },
          control: {
            type: 'file',
