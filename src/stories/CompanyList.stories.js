...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "CompanyList purpose is to render CompanyItem components with company information: name, currency, country, weburl (p.s. pressing on company name will open a stock diagram)",
      },
    },
  },
