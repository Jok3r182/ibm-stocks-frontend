...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "CompanyItemBody purpose is to render every tile line except header (company name) with company information: currency, country, weburl (p.s. use dark background)",
      },
    },
  },
  ...
  argTypes: {
    company: {
      description:
        "Company is an array which consists of company data: name, country, currency and url",
      control: {
        type: "object",
      },
    },
