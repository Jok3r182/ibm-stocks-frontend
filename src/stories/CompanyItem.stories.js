...
export default {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "CompanyItems purpose is to render tile with company information: name, currency, country, weburl",
      },
    },
  },
  ...
  argTypes: {
    companyData: {
      description:
        "Company data is an object which consists of company name, country, currency and url",
      control: {
        type: "object",
      },
    },
